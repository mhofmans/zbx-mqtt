...
def on_message(client, userdata, msg):
    ...
    packet = [
        ZabbixMetric(str(msg.topic).split('/')[0], str(msg.topic).split('/')[2], str(msg.payload.decode('utf-8'))), # 0=hostname 2=itemkey example: p1monitor/phase/l1_v host=p1monitor itemkey=l1_v
    ]
