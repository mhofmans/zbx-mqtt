...
def on_connect(client, userdata, flags, reason_code, properties):
    ...
    client.subscribe("my/test/topic2")
...
# In this example "my" is the zabbix hostname & topic(1-2-3) are itemkeys
    packet = [
        ZabbixMetric(str(msg.topic).split('/')[0], str(msg.topic).split('/')[2], str(msg.payload.decode('utf-8'))),
    ]
